...
$siswa_cisarua = query("SELECT * FROM tb_cibalok WHERE type = 'cisarua_1'");
...
if (isset($_POST['save'])) {
    ...
    foreach ($siswa_cisarua as $siswa) {
        ...
        $sql = "UPDATE tb_cibalok SET kehadiran = '$kehadiran', alasan_tidak_hadir = '$alasan', date = '$tanggal_absen' WHERE id = $siswa_id";
