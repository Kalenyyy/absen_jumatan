...
$siswa_cibedug = query("SELECT * FROM tb_iqram WHERE type = 'cibedug_2'");

if (isset($_POST['save'])) {
    $tanggal_absen = $_POST['tanggal_absen'];

    foreach ($siswa_cibedug as $siswa) {
        $siswa_id = $siswa['id'];
        ...
        $sql = "UPDATE tb_iqram SET kehadiran = '$kehadiran', alasan_tidak_hadir = '$alasan', date = '$tanggal_absen' WHERE id = $siswa_id";
...
<body>
    ...
    <form action="" method="post">
        ...
        <table border="1" cellspacing="0" cellpadding="7">
            ...
            <tbody>
                <?php $angka = 1; ?>
                <?php foreach ($siswa_cibedug as $siswa) : ?>
                    <tr>
                        <td><?= $angka; ?></td>
